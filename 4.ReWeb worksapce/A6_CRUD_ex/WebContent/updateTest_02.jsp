...
<%
	...
	if(cnt == 0){
	response.sendRedirect("updateTest_01.jsp");
	}
...
%>
	...
	<form action = updateTest_03.jsp method = get>
		...
		<td><input type = text name = username value = <%=NAME %> size = 10><br/></td>
		</tr>
		
		<tr>
		<td align = "right" >전화번호 : </td>
		<td><input type = text name = usertel value = <%=TEL %> size = 20><br/></td>
		</tr>
		
		<tr>
		<td align = "right" >주소 : </td>
		<td><input type = text name = useraddress value = <%=ADDRESS %> size = 30><br/></td>
		</tr>
		</table>
